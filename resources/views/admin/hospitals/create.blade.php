...
@section('title', 'Spital - Nou')

@section('content_header', 'Spital <small>adauga spiatl nou</small>')
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active">
                        <form class="form-horizontal" method="POST" action="{{ route('admin.hospitals.store') }}">
